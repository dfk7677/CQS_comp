...
function addPrematchUI() {    
    ...
    mod.AddUIContainer("PreMatchContainer", mod.CreateVector(0,70,0), mod.CreateVector(600, 290, 0), mod.UIAnchor.TopCenter, mod.GetUIRoot(), true, 10, mod.CreateVector(0, 0, 0), 0.4,
        mod.UIBgFill.Solid);
